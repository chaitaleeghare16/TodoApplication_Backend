...
public class GetAllUserManager1 {
	...
	public static List<task> getallusermanager1(String email) throws SQLException, ClassNotFoundException
	{
		System.out.println("inside manager");
        List<task> result = GetAllUserFromDao1.getAllUser1(email);
		return result;
